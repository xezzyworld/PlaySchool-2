...
using Constants = PlaySchool.Models.Constants;
...
namespace PlaySchool.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, ManageAccountService service)
        {
        ...
        //GET: /Manage/UploadProfilePicture
        [HttpGet]
        ...
        {
            string resultMessage = this.service.UploadProfilePicture(file, this.User.Identity.GetUserId(), Server.MapPath(Constants.ProfilePicturePrefix));
            ViewBag.OperationResultMessage = resultMessage;
            return View();
        }
        [HttpGet]
        [Route("ChangeName")]
        ...
        {
            return View(this.service.ChangeName(null,User.Identity.GetUserId()));
        }
        [HttpPost]
        [Route("ChangeName")]
        [ValidateAntiForgeryToken]
        public ActionResult ChangeName(ChangeNameBm bind)
        {
            ...
            ChangeNameViewModel vm = new ChangeNameViewModel() {FirstName = bind.FirstName,LastName = bind.LastName};
            return View(vm);
        }
