...
using PlaySchool.Models.Attributes;
...
namespace PlaySchool.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymousOnly]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterBm bind)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = bind.Username, Email = bind.Email };
                var result = await UserManager.CreateAsync(user, bind.Password);
                if (result.Succeeded)
                {
                    //Every user is with Player role
                    await UserManager.AddToRoleAsync(UserManager.Users.FirstOrDefault(u => u.Email == bind.Email).Id,
                        "Player");
                    await SignInManager.SignInAsync(user, isPersistent:false, rememberBrowser:false);
                    
                    service.RegisterPlayer(bind);
            ...
            RegisterViewModel model = AutoMapper.Mapper.Map<RegisterViewModel>(bind);
        ...
        // GET: /Account/Show/[username]
        [Route(@"Show/{Username:regex(" +Models.Constants.UsernameRegex+ ")?}")]
